...
@php
    ...
    if (@$investData) {
        $route = route('user.invest.payment.insert');
    }else {
        $route = route('user.deposit.insert');
    }
@endphp
@section('content')
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <form action="{{ $route }}" method="post" class="deposit-form">
                @csrf
                                    ...
                                    <div class="deposit-info__input">
                                        <div class="deposit-info__input-group input-group">
                                            ...
                                            <input type="text" class="form-control form--control amount" name="amount"
                                                ...
                                                value="@if(@$investData['invest_amount']){{ getAmount(@$investData['invest_amount']) }}@else{{ old('amount') }}@endif"
                                                @if (@$investData) disabled @endif autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <hr>
