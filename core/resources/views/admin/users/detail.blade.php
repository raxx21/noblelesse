            ...
            <div class="row gy-4">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" link="{{ route('admin.report.transaction', $user->id) }}"
                        icon="las la-money-bill-wave-alt" title="Balance" value="{{ showAmount($user->balance) }}"
                        bg="indigo" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" link="{{ route('admin.deposit.list', $user->id) }}" icon="las la-wallet"
                        title="Deposits" value="{{ showAmount($totalDeposit) }}" bg="success" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" link="{{ route('admin.withdraw.data.all', $user->id) }}" icon="la la-bank"
                        title="Withdrawals" value="{{ showAmount($totalWithdrawals) }}" bg="6" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" link="{{ route('admin.report.transaction', $user->id) }}"
                        icon="las la-exchange-alt" title="Transactions" value="{{ $totalTransaction }}" bg="info" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" outline="true"
                        link="{{ route('admin.invest.all') }}?search={{ $user->username }}" icon="fas fa-city"
                        title="Invested Property" value="{{ $propertyInvest['total_invested_property'] }}"
                        bg="indigo" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" outline="true"
                        link="{{ route('admin.invest.all') }}?search={{ $user->username }}" icon="fas fa-donate"
                        title="Total Invest" value="{{ showAmount($propertyInvest['total_invest']) }}" bg="success" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" outline="true"
                        link="{{ route('admin.invest.all') }}?search={{ $user->username }}" icon="fas fa-credit-card"
                        title="Due Amount" value="{{ showAmount($propertyInvest['total_due_amount']) }}" bg="6" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" outline="true"
                        link="{{ route('admin.invest.profit') }}?search={{ $user->username }}" icon="fas fa-coins"
                        title="Total Profit" value="{{ showAmount($propertyInvest['total_profit']) }}" bg="info" />
                </div>
            </div>
